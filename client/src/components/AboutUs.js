...
export default function AboutUs() {
  ...
  return (
    <div className="aboutUs">
      ...
      >
        <Typography variant="h2" fontFamily="Arvo" fontWeight="700" color="#66FCF1" textAlign="center" sx={{ marginTop: "50px", marginBottom: "0px" }}>
          About Us
        </Typography>
        <Box
          component="section"
        ...
        >
          <Container sx={{ mt: 6, mb: 15, display: "flex", position: "relative" }}>
            <Grid container spacing={5}>
              ...
              <Grid item xs={12}>
                <Typography variant="h3" fontFamily="Arvo" fontWeight="700" color="#66FCF1" textAlign="center" sx={{ marginTop: "85px", marginBottom: "8px" }}>
                  Technologies
                </Typography>
              </Grid>
