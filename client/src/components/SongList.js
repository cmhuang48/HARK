        ...
        <Box sx={{ marginTop: "100px", marginBottom: "30px" }}>
          ...
          <div className="songSelect">
            {songs?.map((song) => {
              ...
              return (
                <div key={song.id} style={{ margin: "1rem" }} onClick={() => this.handleSelect(song)}>
                  <Typography color="#f2f2f2" sx={{ lineHeight: 2, bgcolor: "transparent", "&:hover": { bgcolor: "transparent" } }} style={{ width: "100%", fontSize: "1.5rem" }}>
